...
ROOT = Path('.')
REPORT = ROOT / 'outputs/daily-report-zh-dynamic-v1.md'
CHUNKS = ROOT / 'test-output/discord-chunked-delivery-zh-v1.json'
DELIVERY = ROOT / 'test-output/discord-delivery-zh-result-v1.json'
...
def main():
    run(['python3', 'scripts-v2/build_daily_report_zh_dynamic_v1.py'])
